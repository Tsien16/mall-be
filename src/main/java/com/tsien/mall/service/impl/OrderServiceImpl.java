...
public class OrderServiceImpl implements IOrderService {
    ...
    public OrderServiceImpl(OrderMapper orderMapper, OrderItemMapper orderItemMapper, PayInfoMapper payInfoMapper,
                            CartMapper cartMapper, ProductMapper productMapper, ShippingMapper shippingMapper) {
    ...
    private ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            orderItem.setTotalPrice(BigDecimalUtil.mul(product.getPrice().doubleValue(), Double.valueOf(cartItem.getQuantity())));
